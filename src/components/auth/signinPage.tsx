        ...
        <div className='lg:p-8'>
          <div className='mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]'>
            ...
            <p className='px-8 text-center text-sm text-muted-foreground'>
              ...
              <Link href='/terms' className='underline px-1 underline-offset-4 hover:text-primary'>
                Terms of Service
              </Link>
              and
              <Link href='/privacy' className='underline px-1 underline-offset-4 hover:text-primary'>
                Privacy Policy
              </Link>
              .
            </p>
